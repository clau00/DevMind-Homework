...
public class SumatorNrFoarteMari {
	
	

	public LinkedList<Integer> sumNb(LinkedList<Integer> op1, LinkedList<Integer> op2){
	...
	public static void main(String[] args) {
		...
		SumatorNrFoarteMari  sum = new SumatorNrFoarteMari();
		
		System.out.println(noToString(sum.sumNb(op1, op2)));
